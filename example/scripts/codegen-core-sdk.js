#!/usr/bin/env node
/**
 * Runs codegen for truvideo-react-turbo-core-sdk and applies the package-name patch
...
const coreSdkDir = path.join(exampleDir, 'node_modules', 'truvideo-react-turbo-core-sdk');

if (!fs.existsSync(coreSdkDir)) {
  console.warn('truvideo-react-turbo-core-sdk not found, skipping codegen');
  process.exit(0);
}

// 1) React Native codegen (creates android/generated/jni and java/com/facebook/fbreact/specs)
execSync('npx react-native codegen --path node_modules/truvideo-react-turbo-core-sdk', {
  cwd: exampleDir,
  stdio: 'inherit',
});
